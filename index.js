(function (Scratch) {
  'use strict';
    ...
    const formatMessage = Scratch.require('format-message');
    const ArgumentType = Scratch.require('../../extension-support/argument-type');
    const BlockType = Scratch.require('../../extension-support/block-type');
    const Cast = Scratch.require('../../util/cast');
    const Color = Scratch.require('../../util/color');
    const Clone = Scratch.require('../../util/clone');
    const Timer = Scratch.require('../../util/timer');
